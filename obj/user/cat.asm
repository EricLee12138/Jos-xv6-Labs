...
umain(int argc, char **argv)
{
  ...
  8000e8:	e8 de 14 00 00       	call   8015cb <open>
  ...
  800102:	e8 62 16 00 00       	call   801769 <printf>
...
stat(const char *path, struct Stat *stat)
{
  ...
  8013e3:	e8 e3 01 00 00       	call   8015cb <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  80142a:	e8 f5 08 00 00       	call   801d24 <ipc_find_env>
  ...
  801445:	e8 86 08 00 00       	call   801cd0 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  80144a:	83 c4 0c             	add    $0xc,%esp
  80144d:	6a 00                	push   $0x0
  80144f:	53                   	push   %ebx
  801450:	6a 00                	push   $0x0
  801452:	e8 07 08 00 00       	call   801c5e <ipc_recv>
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801575:	78 4b                	js     8015c2 <devfile_read+0x79>
		return r;
	assert(r <= n);
  801577:	39 c6                	cmp    %eax,%esi
  801579:	73 16                	jae    801591 <devfile_read+0x48>
  80157b:	68 7c 24 80 00       	push   $0x80247c
  801580:	68 83 24 80 00       	push   $0x802483
  801585:	6a 7c                	push   $0x7c
  801587:	68 98 24 80 00       	push   $0x802498
  80158c:	e8 02 ec ff ff       	call   800193 <_panic>
	assert(r <= PGSIZE);
  801591:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801596:	7e 16                	jle    8015ae <devfile_read+0x65>
  801598:	68 a3 24 80 00       	push   $0x8024a3
  80159d:	68 83 24 80 00       	push   $0x802483
  8015a2:	6a 7d                	push   $0x7d
  8015a4:	68 98 24 80 00       	push   $0x802498
  8015a9:	e8 e5 eb ff ff       	call   800193 <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  8015ae:	83 ec 04             	sub    $0x4,%esp
  8015b1:	50                   	push   %eax
  8015b2:	68 00 70 80 00       	push   $0x807000
  8015b7:	ff 75 0c             	pushl  0xc(%ebp)
  8015ba:	e8 43 f4 ff ff       	call   800a02 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8015d5:	53                   	push   %ebx
  8015d6:	e8 5c f2 ff ff       	call   800837 <strlen>
  8015db:	83 c4 10             	add    $0x10,%esp
  8015de:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  8015e3:	7f 67                	jg     80164c <open+0x81>
		return -E_BAD_PATH;
  ...
  8015eb:	50                   	push   %eax
  8015ec:	e8 9a f8 ff ff       	call   800e8b <fd_alloc>
  ...
  8015f8:	78 57                	js     801651 <open+0x86>
		return r;
  ...
  80164a:	eb 05                	jmp    801651 <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  80164c:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
...
sync(void)
{
  ...
  801668:	e8 a6 fd ff ff       	call   801413 <fsipc>
}
  80166d:	c9                   	leave  
  80166e:	c3                   	ret    
...
{
	if (b->error > 0) {
  80166f:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
  801673:	7e 37                	jle    8016ac <writebuf+0x3d>
};
...
writebuf(struct printbuf *b)
{
  ...
  80167e:	ff 70 04             	pushl  0x4(%eax)
  801681:	8d 40 10             	lea    0x10(%eax),%eax
  801684:	50                   	push   %eax
  801685:	ff 33                	pushl  (%ebx)
  801687:	e8 8e fb ff ff       	call   80121a <write>
		if (result > 0)
  80168c:	83 c4 10             	add    $0x10,%esp
  80168f:	85 c0                	test   %eax,%eax
  801691:	7e 03                	jle    801696 <writebuf+0x27>
			b->result += result;
  801693:	01 43 08             	add    %eax,0x8(%ebx)
		if (result != b->idx) // error, or wrote less than supplied
  801696:	3b 43 04             	cmp    0x4(%ebx),%eax
  801699:	74 0d                	je     8016a8 <writebuf+0x39>
			b->error = (result < 0 ? result : 0);
  80169b:	85 c0                	test   %eax,%eax
  80169d:	ba 00 00 00 00       	mov    $0x0,%edx
  8016a2:	0f 4f c2             	cmovg  %edx,%eax
  8016a5:	89 43 0c             	mov    %eax,0xc(%ebx)
	}
}
  8016a8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  8016ab:	c9                   	leave  
  8016ac:	f3 c3                	repz ret 
...
putch(int ch, void *thunk)
{
  ...
  8016b5:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	b->buf[b->idx++] = ch;
  8016b8:	8b 53 04             	mov    0x4(%ebx),%edx
  8016bb:	8d 42 01             	lea    0x1(%edx),%eax
  8016be:	89 43 04             	mov    %eax,0x4(%ebx)
  8016c1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8016c4:	88 4c 13 10          	mov    %cl,0x10(%ebx,%edx,1)
	if (b->idx == 256) {
  8016c8:	3d 00 01 00 00       	cmp    $0x100,%eax
  8016cd:	75 0e                	jne    8016dd <putch+0x2f>
		writebuf(b);
  8016cf:	89 d8                	mov    %ebx,%eax
  8016d1:	e8 99 ff ff ff       	call   80166f <writebuf>
		b->idx = 0;
  8016d6:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	}
}
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  8016e6:	81 ec 18 01 00 00    	sub    $0x118,%esp
	struct printbuf b;

	b.fd = fd;
  8016ec:	8b 45 08             	mov    0x8(%ebp),%eax
  8016ef:	89 85 e8 fe ff ff    	mov    %eax,-0x118(%ebp)
	b.idx = 0;
  8016f5:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%ebp)
  8016fc:	00 00 00 
	b.result = 0;
  8016ff:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  801706:	00 00 00 
	b.error = 1;
  801709:	c7 85 f4 fe ff ff 01 	movl   $0x1,-0x10c(%ebp)
  801710:	00 00 00 
	vprintfmt(putch, &b, fmt, ap);
  801713:	ff 75 10             	pushl  0x10(%ebp)
  801716:	ff 75 0c             	pushl  0xc(%ebp)
  801719:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  80171f:	50                   	push   %eax
  801720:	68 ae 16 80 00       	push   $0x8016ae
  801725:	e8 3f ec ff ff       	call   800369 <vprintfmt>
	if (b.idx > 0)
  80172a:	83 c4 10             	add    $0x10,%esp
  80172d:	83 bd ec fe ff ff 00 	cmpl   $0x0,-0x114(%ebp)
  801734:	7e 0b                	jle    801741 <vfprintf+0x5e>
		writebuf(&b);
  801736:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  80173c:	e8 2e ff ff ff       	call   80166f <writebuf>

	return (b.result ? b.result : b.error);
  801741:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  801747:	85 c0                	test   %eax,%eax
  801749:	0f 44 85 f4 fe ff ff 	cmove  -0x10c(%ebp),%eax
}
  801750:	c9                   	leave  
  801751:	c3                   	ret    
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  801755:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  801758:	8d 45 10             	lea    0x10(%ebp),%eax
	cnt = vfprintf(fd, fmt, ap);
  80175b:	50                   	push   %eax
  80175c:	ff 75 0c             	pushl  0xc(%ebp)
  80175f:	ff 75 08             	pushl  0x8(%ebp)
  801762:	e8 7c ff ff ff       	call   8016e3 <vfprintf>
	va_end(ap);
...
printf(const char *fmt, ...)
{
  ...
  80176c:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  80176f:	8d 45 0c             	lea    0xc(%ebp),%eax
	cnt = vfprintf(1, fmt, ap);
  801772:	50                   	push   %eax
  801773:	ff 75 08             	pushl  0x8(%ebp)
  801776:	6a 01                	push   $0x1
  801778:	e8 66 ff ff ff       	call   8016e3 <vfprintf>
	va_end(ap);
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80178d:	e8 e2 f6 ff ff       	call   800e74 <fd2data>
  801792:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801794:	83 c4 08             	add    $0x8,%esp
  801797:	68 af 24 80 00       	push   $0x8024af
  80179c:	53                   	push   %ebx
  80179d:	e8 ce f0 ff ff       	call   800870 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  8017a2:	8b 46 04             	mov    0x4(%esi),%eax
  8017a5:	2b 06                	sub    (%esi),%eax
  8017a7:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  8017ad:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  8017b4:	00 00 00 
	stat->st_dev = &devpipe;
  8017b7:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  8017be:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8017da:	e8 19 f5 ff ff       	call   800cf8 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  8017df:	89 1c 24             	mov    %ebx,(%esp)
  8017e2:	e8 8d f6 ff ff       	call   800e74 <fd2data>
  8017e7:	83 c4 08             	add    $0x8,%esp
  8017ea:	50                   	push   %eax
  8017eb:	6a 00                	push   $0x0
  8017ed:	e8 06 f5 ff ff       	call   800cf8 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801803:	89 d7                	mov    %edx,%edi
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  801805:	a1 20 60 80 00       	mov    0x806020,%eax
  80180a:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  80180d:	83 ec 0c             	sub    $0xc,%esp
  801810:	ff 75 e0             	pushl  -0x20(%ebp)
  801813:	e8 45 05 00 00       	call   801d5d <pageref>
  801818:	89 c3                	mov    %eax,%ebx
  80181a:	89 3c 24             	mov    %edi,(%esp)
  80181d:	e8 3b 05 00 00       	call   801d5d <pageref>
  801822:	83 c4 10             	add    $0x10,%esp
  801825:	39 c3                	cmp    %eax,%ebx
  801827:	0f 94 c1             	sete   %cl
  80182a:	0f b6 c9             	movzbl %cl,%ecx
  80182d:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801830:	8b 15 20 60 80 00    	mov    0x806020,%edx
  801836:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801839:	39 ce                	cmp    %ecx,%esi
  80183b:	74 1b                	je     801858 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  80183d:	39 c3                	cmp    %eax,%ebx
  80183f:	75 c4                	jne    801805 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801841:	8b 42 58             	mov    0x58(%edx),%eax
  801844:	ff 75 e4             	pushl  -0x1c(%ebp)
  801847:	50                   	push   %eax
  801848:	56                   	push   %esi
  801849:	68 b6 24 80 00       	push   $0x8024b6
  80184e:	e8 19 ea ff ff       	call   80026c <cprintf>
  801853:	83 c4 10             	add    $0x10,%esp
  801856:	eb ad                	jmp    801805 <_pipeisclosed+0xe>
	}
}
  801858:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80186f:	56                   	push   %esi
  801870:	e8 ff f5 ff ff       	call   800e74 <fd2data>
  ...
  80187f:	eb 4b                	jmp    8018cc <devpipe_write+0x69>
  ...
  801885:	e8 6d ff ff ff       	call   8017f7 <_pipeisclosed>
  80188a:	85 c0                	test   %eax,%eax
  80188c:	75 48                	jne    8018d6 <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  80188e:	e8 c1 f3 ff ff       	call   800c54 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  801893:	8b 43 04             	mov    0x4(%ebx),%eax
  801896:	8b 0b                	mov    (%ebx),%ecx
  801898:	8d 51 20             	lea    0x20(%ecx),%edx
  80189b:	39 d0                	cmp    %edx,%eax
  80189d:	73 e2                	jae    801881 <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  8018a2:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  8018a6:	88 4d e7             	mov    %cl,-0x19(%ebp)
  8018a9:	89 c2                	mov    %eax,%edx
  8018ab:	c1 fa 1f             	sar    $0x1f,%edx
  8018ae:	89 d1                	mov    %edx,%ecx
  8018b0:	c1 e9 1b             	shr    $0x1b,%ecx
  8018b3:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  8018b6:	83 e2 1f             	and    $0x1f,%edx
  8018b9:	29 ca                	sub    %ecx,%edx
  8018bb:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  8018bf:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  ...
  8018cf:	75 c2                	jne    801893 <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  8018d4:	eb 05                	jmp    8018db <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8018ec:	8b 7d 08             	mov    0x8(%ebp),%edi
	uint8_t *buf;
	size_t i;
	struct Pipe *p;
	...
	p = (struct Pipe*)fd2data(fd);
  8018ef:	57                   	push   %edi
  8018f0:	e8 7f f5 ff ff       	call   800e74 <fd2data>
  ...
  8018ff:	eb 3d                	jmp    80193e <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  801901:	85 db                	test   %ebx,%ebx
  801903:	74 04                	je     801909 <devpipe_read+0x26>
				return i;
  801905:	89 d8                	mov    %ebx,%eax
  801907:	eb 44                	jmp    80194d <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  801909:	89 f2                	mov    %esi,%edx
  80190b:	89 f8                	mov    %edi,%eax
  80190d:	e8 e5 fe ff ff       	call   8017f7 <_pipeisclosed>
  801912:	85 c0                	test   %eax,%eax
  801914:	75 32                	jne    801948 <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  801916:	e8 39 f3 ff ff       	call   800c54 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  80191d:	3b 46 04             	cmp    0x4(%esi),%eax
  801920:	74 df                	je     801901 <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  80192d:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  801932:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801935:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  801938:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  80193b:	83 c3 01             	add    $0x1,%ebx
  80193e:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  801941:	75 d8                	jne    80191b <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  801946:	eb 05                	jmp    80194d <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  8019d0:	e8 9f f4 ff ff       	call   800e74 <fd2data>
  ...
  8019e2:	e8 8c f2 ff ff       	call   800c73 <sys_page_alloc>
  8019e7:	89 c3                	mov    %eax,%ebx
  8019e9:	83 c4 10             	add    $0x10,%esp
  8019ec:	85 c0                	test   %eax,%eax
  8019ee:	0f 88 89 00 00 00    	js     801a7d <pipe+0x128>
		goto err2;
	if ((r = sys_page_map(0, va, 0, fd2data(fd1), PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  8019f4:	83 ec 0c             	sub    $0xc,%esp
  8019f7:	ff 75 f0             	pushl  -0x10(%ebp)
  8019fa:	e8 75 f4 ff ff       	call   800e74 <fd2data>
  8019ff:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801a06:	50                   	push   %eax
  801a07:	6a 00                	push   $0x0
  801a09:	56                   	push   %esi
  801a0a:	6a 00                	push   $0x0
  801a0c:	e8 a5 f2 ff ff       	call   800cb6 <sys_page_map>
  801a11:	89 c3                	mov    %eax,%ebx
  801a13:	83 c4 20             	add    $0x20,%esp
  801a16:	85 c0                	test   %eax,%eax
  801a18:	78 55                	js     801a6f <pipe+0x11a>
		goto err3;

	// set up fd structures
	fd0->fd_dev_id = devpipe.dev_id;
  801a1a:	8b 15 20 30 80 00    	mov    0x803020,%edx
  801a20:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a23:	89 10                	mov    %edx,(%eax)
	fd0->fd_omode = O_RDONLY;
  801a25:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a28:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)

	fd1->fd_dev_id = devpipe.dev_id;
  801a2f:	8b 15 20 30 80 00    	mov    0x803020,%edx
  ...
  801a6d:	eb 30                	jmp    801a9f <pipe+0x14a>
  ...
  801a75:	e8 7e f2 ff ff       	call   800cf8 <sys_page_unmap>
  ...
  801a85:	e8 6e f2 ff ff       	call   800cf8 <sys_page_unmap>
  ...
  801a95:	e8 5e f2 ff ff       	call   800cf8 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801ab5:	e8 20 f4 ff ff       	call   800eda <fd_lookup>
  ...
  801ac7:	e8 a8 f3 ff ff       	call   800e74 <fd2data>
	return _pipeisclosed(fd, p);
  801acc:	89 c2                	mov    %eax,%edx
  801ace:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ad1:	e8 21 fd ff ff       	call   8017f7 <_pipeisclosed>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801aeb:	68 ce 24 80 00       	push   $0x8024ce
  801af0:	ff 75 0c             	pushl  0xc(%ebp)
  801af3:	e8 78 ed ff ff       	call   800870 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801b10:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801b16:	eb 2d                	jmp    801b45 <devcons_write+0x46>
		m = n - tot;
  801b18:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801b1b:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  801b1d:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  801b20:	ba 7f 00 00 00       	mov    $0x7f,%edx
  801b25:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  ...
  801b2f:	50                   	push   %eax
  801b30:	57                   	push   %edi
  801b31:	e8 cc ee ff ff       	call   800a02 <memmove>
		sys_cputs(buf, m);
  801b36:	83 c4 08             	add    $0x8,%esp
  801b39:	53                   	push   %ebx
  801b3a:	57                   	push   %edi
  801b3b:	e8 77 f0 ff ff       	call   800bb7 <sys_cputs>
	int tot, m;
	char buf[128];
  ...
  801b47:	3b 75 10             	cmp    0x10(%ebp),%esi
  801b4a:	72 cc                	jb     801b18 <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801b63:	74 2a                	je     801b8f <devcons_read+0x3b>
  801b65:	eb 05                	jmp    801b6c <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801b67:	e8 e8 f0 ff ff       	call   800c54 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801b6c:	e8 64 f0 ff ff       	call   800bd5 <sys_cgetc>
  801b71:	85 c0                	test   %eax,%eax
  801b73:	74 f2                	je     801b67 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  801b75:	85 c0                	test   %eax,%eax
  801b77:	78 16                	js     801b8f <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801b79:	83 f8 04             	cmp    $0x4,%eax
  801b7c:	74 0c                	je     801b8a <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  801b7e:	8b 55 0c             	mov    0xc(%ebp),%edx
  801b81:	88 02                	mov    %al,(%edx)
	return 1;
  801b83:	b8 01 00 00 00       	mov    $0x1,%eax
  801b88:	eb 05                	jmp    801b8f <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  801b9a:	88 45 f7             	mov    %al,-0x9(%ebp)
  ...
  801ba2:	50                   	push   %eax
  801ba3:	e8 0f f0 ff ff       	call   800bb7 <sys_cputs>
}
...
getchar(void)
{
  ...
  801bbb:	e8 80 f5 ff ff       	call   801140 <read>
	if (r < 0)
  801bc0:	83 c4 10             	add    $0x10,%esp
  801bc3:	85 c0                	test   %eax,%eax
  801bc5:	78 0f                	js     801bd6 <getchar+0x29>
		return r;
	if (r < 1)
  801bc7:	85 c0                	test   %eax,%eax
  801bc9:	7e 06                	jle    801bd1 <getchar+0x24>
		return -E_EOF;
	return c;
  801bcb:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  801bcf:	eb 05                	jmp    801bd6 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  801bd1:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  801bd6:	c9                   	leave  
  801bd7:	c3                   	ret    
...
opencons(void)
{
  ...
  801c0d:	50                   	push   %eax
  801c0e:	e8 78 f2 ff ff       	call   800e8b <fd_alloc>
...
opencons(void)
{
  ...
  801c1a:	78 3e                	js     801c5a <opencons+0x56>
		return r;
  ...
  801c29:	e8 45 f0 ff ff       	call   800c73 <sys_page_alloc>
  ...
  801c35:	78 23                	js     801c5a <opencons+0x56>
		return r;
	fd->fd_dev_id = devcons.dev_id;
  801c37:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  801c3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c40:	89 10                	mov    %edx,(%eax)
	fd->fd_omode = O_RDWR;
  801c42:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c45:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%eax)
	return fd2num(fd);
  801c4c:	83 ec 0c             	sub    $0xc,%esp
  801c4f:	50                   	push   %eax
  801c50:	e8 0f f2 ff ff       	call   800e64 <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c6e:	74 0e                	je     801c7e <ipc_recv+0x20>
        r = sys_ipc_recv(pg);
  801c70:	83 ec 0c             	sub    $0xc,%esp
  801c73:	50                   	push   %eax
  801c74:	e8 aa f1 ff ff       	call   800e23 <sys_ipc_recv>
  801c79:	83 c4 10             	add    $0x10,%esp
  801c7c:	eb 0d                	jmp    801c8b <ipc_recv+0x2d>
	else
        r = sys_ipc_recv((void *)-1);
  801c7e:	83 ec 0c             	sub    $0xc,%esp
  801c81:	6a ff                	push   $0xffffffff
  801c83:	e8 9b f1 ff ff       	call   800e23 <sys_ipc_recv>
  801c88:	83 c4 10             	add    $0x10,%esp

	if (r < 0) {
  801c8b:	85 c0                	test   %eax,%eax
  801c8d:	79 16                	jns    801ca5 <ipc_recv+0x47>

		if (from_env_store != NULL)
  801c8f:	85 f6                	test   %esi,%esi
  801c91:	74 06                	je     801c99 <ipc_recv+0x3b>
			*from_env_store = 0;
  801c93:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store != NULL)
  801c99:	85 db                	test   %ebx,%ebx
  801c9b:	74 2c                	je     801cc9 <ipc_recv+0x6b>
			*perm_store = 0;
  801c9d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801ca3:	eb 24                	jmp    801cc9 <ipc_recv+0x6b>
		return r;
  ...
  801ca7:	74 0a                	je     801cb3 <ipc_recv+0x55>
			*from_env_store = thisenv->env_ipc_from;
  801ca9:	a1 20 60 80 00       	mov    0x806020,%eax
  801cae:	8b 40 74             	mov    0x74(%eax),%eax
  801cb1:	89 06                	mov    %eax,(%esi)
		if (perm_store != NULL)
  801cb3:	85 db                	test   %ebx,%ebx
  801cb5:	74 0a                	je     801cc1 <ipc_recv+0x63>
			*perm_store = thisenv->env_ipc_perm;
  801cb7:	a1 20 60 80 00       	mov    0x806020,%eax
  801cbc:	8b 40 78             	mov    0x78(%eax),%eax
  801cbf:	89 03                	mov    %eax,(%ebx)
		return thisenv->env_ipc_value;
  801cc1:	a1 20 60 80 00       	mov    0x806020,%eax
  801cc6:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ce2:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;	
  801ce4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ...
  801cf0:	56                   	push   %esi
  801cf1:	57                   	push   %edi
  801cf2:	e8 09 f1 ff ff       	call   800e00 <sys_ipc_try_send>
		if (r >= 0)
  801cf7:	83 c4 10             	add    $0x10,%esp
  801cfa:	85 c0                	test   %eax,%eax
  801cfc:	79 1e                	jns    801d1c <ipc_send+0x4c>
			return;
		else if (r != -E_IPC_NOT_RECV)
  801cfe:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d01:	74 12                	je     801d15 <ipc_send+0x45>
			panic("ipc_send error: %e", r);
  801d03:	50                   	push   %eax
  801d04:	68 da 24 80 00       	push   $0x8024da
  801d09:	6a 49                	push   $0x49
  801d0b:	68 ed 24 80 00       	push   $0x8024ed
  801d10:	e8 7e e4 ff ff       	call   800193 <_panic>
	
		sys_yield();
  801d15:	e8 3a ef ff ff       	call   800c54 <sys_yield>
	}
  801d1a:	eb d0                	jmp    801cec <ipc_send+0x1c>
...
ipc_find_env(enum EnvType type)
{
  ...
  801d2f:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801d32:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801d38:	8b 52 50             	mov    0x50(%edx),%edx
  801d3b:	39 ca                	cmp    %ecx,%edx
  801d3d:	75 0d                	jne    801d4c <ipc_find_env+0x28>
			return envs[i].env_id;
  801d3f:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801d42:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801d47:	8b 40 48             	mov    0x48(%eax),%eax
  801d4a:	eb 0f                	jmp    801d5b <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801d4f:	3d 00 04 00 00       	cmp    $0x400,%eax
  801d54:	75 d9                	jne    801d2f <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801d65:	c1 e8 16             	shr    $0x16,%eax
  801d68:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801d74:	f6 c1 01             	test   $0x1,%cl
  801d77:	74 1d                	je     801d96 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801d79:	c1 ea 0c             	shr    $0xc,%edx
  801d7c:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801d83:	f6 c2 01             	test   $0x1,%dl
  801d86:	74 0e                	je     801d96 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801d88:	c1 ea 0c             	shr    $0xc,%edx
  801d8b:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801d92:	ef 
  801d93:	0f b7 c0             	movzwl %ax,%eax
}
  801d96:	5d                   	pop    %ebp
  801d97:	c3                   	ret    
