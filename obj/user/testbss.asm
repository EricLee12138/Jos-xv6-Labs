	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800278:	e8 c3 19 00 00       	call   801c40 <__udivdi3>
  ...
  8002bb:	e8 b0 1a 00 00       	call   801d70 <__umoddi3>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013d3:	e8 e5 07 00 00       	call   801bbd <ipc_find_env>
  ...
  8013ee:	e8 76 07 00 00       	call   801b69 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8013f3:	83 c4 0c             	add    $0xc,%esp
  8013f6:	6a 00                	push   $0x0
  8013f8:	53                   	push   %ebx
  8013f9:	6a 00                	push   $0x0
  8013fb:	e8 f7 06 00 00       	call   801af7 <ipc_recv>
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801530:	68 98 23 80 00       	push   $0x802398
  801535:	e8 02 ec ff ff       	call   80013c <_panic>
	assert(r <= PGSIZE);
  80153a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80153f:	7e 16                	jle    801557 <devfile_read+0x65>
  801541:	68 a3 23 80 00       	push   $0x8023a3
  801546:	68 83 23 80 00       	push   $0x802383
  80154b:	6a 7d                	push   $0x7d
  80154d:	68 98 23 80 00       	push   $0x802398
  801552:	e8 e5 eb ff ff       	call   80013c <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801557:	83 ec 04             	sub    $0x4,%esp
  80155a:	50                   	push   %eax
  80155b:	68 00 50 c0 00       	push   $0xc05000
  801560:	ff 75 0c             	pushl  0xc(%ebp)
  801563:	e8 43 f4 ff ff       	call   8009ab <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  80157e:	53                   	push   %ebx
  80157f:	e8 5c f2 ff ff       	call   8007e0 <strlen>
  ...
  8015a6:	53                   	push   %ebx
  8015a7:	68 00 50 c0 00       	push   $0xc05000
  8015ac:	e8 68 f2 ff ff       	call   800819 <strcpy>
	fsipcbuf.open.req_omode = mode;
  8015b1:	8b 45 0c             	mov    0xc(%ebp),%eax
  8015b4:	a3 00 54 c0 00       	mov    %eax,0xc05400
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801630:	68 af 23 80 00       	push   $0x8023af
  801635:	53                   	push   %ebx
  801636:	e8 de f1 ff ff       	call   800819 <strcpy>
...
devpipe_close(struct Fd *fd)
{
  ...
  801673:	e8 29 f6 ff ff       	call   800ca1 <sys_page_unmap>
  ...
  801686:	e8 16 f6 ff ff       	call   800ca1 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8016c6:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  8016c9:	8b 15 20 40 c0 00    	mov    0xc04020,%edx
  ...
  8016e0:	50                   	push   %eax
  8016e1:	56                   	push   %esi
  8016e2:	68 b6 23 80 00       	push   $0x8023b6
  8016e7:	e8 29 eb ff ff       	call   800215 <cprintf>
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801725:	75 48                	jne    80176f <devpipe_write+0x73>
			...
			sys_yield();
  801727:	e8 d1 f4 ff ff       	call   800bfd <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8017ad:	75 32                	jne    8017e1 <devpipe_read+0x65>
			...
			sys_yield();
  8017af:	e8 49 f4 ff ff       	call   800bfd <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801819:	e8 fe f3 ff ff       	call   800c1c <sys_page_alloc>
  ...
  801851:	e8 c6 f3 ff ff       	call   800c1c <sys_page_alloc>
  ...
  80187b:	e8 9c f3 ff ff       	call   800c1c <sys_page_alloc>
  ...
  8018a5:	e8 b5 f3 ff ff       	call   800c5f <sys_page_map>
  ...
  80190e:	e8 8e f3 ff ff       	call   800ca1 <sys_page_unmap>
  ...
  80191e:	e8 7e f3 ff ff       	call   800ca1 <sys_page_unmap>
  ...
  80192e:	e8 6e f3 ff ff       	call   800ca1 <sys_page_unmap>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801984:	68 ce 23 80 00       	push   $0x8023ce
  801989:	ff 75 0c             	pushl  0xc(%ebp)
  80198c:	e8 88 ee ff ff       	call   800819 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8019c8:	50                   	push   %eax
  8019c9:	57                   	push   %edi
  8019ca:	e8 dc ef ff ff       	call   8009ab <memmove>
		sys_cputs(buf, m);
  8019cf:	83 c4 08             	add    $0x8,%esp
  8019d2:	53                   	push   %ebx
  8019d3:	57                   	push   %edi
  8019d4:	e8 87 f1 ff ff       	call   800b60 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8019fe:	eb 05                	jmp    801a05 <devcons_read+0x18>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801a00:	e8 f8 f1 ff ff       	call   800bfd <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801a05:	e8 74 f1 ff ff       	call   800b7e <sys_cgetc>
...
cputchar(int ch)
{
  ...
  801a3b:	50                   	push   %eax
  801a3c:	e8 1f f1 ff ff       	call   800b60 <sys_cputs>
}
...
opencons(void)
{
  ...
  801ac2:	e8 55 f1 ff ff       	call   800c1c <sys_page_alloc>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b07:	74 0e                	je     801b17 <ipc_recv+0x20>
        r = sys_ipc_recv(pg);
  801b09:	83 ec 0c             	sub    $0xc,%esp
  801b0c:	50                   	push   %eax
  801b0d:	e8 ba f2 ff ff       	call   800dcc <sys_ipc_recv>
  801b12:	83 c4 10             	add    $0x10,%esp
  801b15:	eb 0d                	jmp    801b24 <ipc_recv+0x2d>
	else
        r = sys_ipc_recv((void *)-1);
  801b17:	83 ec 0c             	sub    $0xc,%esp
  801b1a:	6a ff                	push   $0xffffffff
  801b1c:	e8 ab f2 ff ff       	call   800dcc <sys_ipc_recv>
  801b21:	83 c4 10             	add    $0x10,%esp

	if (r < 0) {
  801b24:	85 c0                	test   %eax,%eax
  801b26:	79 16                	jns    801b3e <ipc_recv+0x47>

		if (from_env_store != NULL)
  801b28:	85 f6                	test   %esi,%esi
  801b2a:	74 06                	je     801b32 <ipc_recv+0x3b>
			*from_env_store = 0;
  801b2c:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store != NULL)
  801b32:	85 db                	test   %ebx,%ebx
  801b34:	74 2c                	je     801b62 <ipc_recv+0x6b>
			*perm_store = 0;
  801b36:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801b3c:	eb 24                	jmp    801b62 <ipc_recv+0x6b>
		return r;
  ...
  801b40:	74 0a                	je     801b4c <ipc_recv+0x55>
			*from_env_store = thisenv->env_ipc_from;
  801b42:	a1 20 40 c0 00       	mov    0xc04020,%eax
  801b47:	8b 40 74             	mov    0x74(%eax),%eax
  801b4a:	89 06                	mov    %eax,(%esi)
		if (perm_store != NULL)
  801b4c:	85 db                	test   %ebx,%ebx
  801b4e:	74 0a                	je     801b5a <ipc_recv+0x63>
			*perm_store = thisenv->env_ipc_perm;
  801b50:	a1 20 40 c0 00       	mov    0xc04020,%eax
  801b55:	8b 40 78             	mov    0x78(%eax),%eax
  801b58:	89 03                	mov    %eax,(%ebx)
		return thisenv->env_ipc_value;
  801b5a:	a1 20 40 c0 00       	mov    0xc04020,%eax
  801b5f:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b89:	56                   	push   %esi
  801b8a:	57                   	push   %edi
  801b8b:	e8 19 f2 ff ff       	call   800da9 <sys_ipc_try_send>
		if (r >= 0)
  801b90:	83 c4 10             	add    $0x10,%esp
  801b93:	85 c0                	test   %eax,%eax
  801b95:	79 1e                	jns    801bb5 <ipc_send+0x4c>
			return;
		else if (r != -E_IPC_NOT_RECV)
  801b97:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801b9a:	74 12                	je     801bae <ipc_send+0x45>
			panic("ipc_send error: %e", r);
  801b9c:	50                   	push   %eax
  801b9d:	68 da 23 80 00       	push   $0x8023da
  801ba2:	6a 49                	push   $0x49
  801ba4:	68 ed 23 80 00       	push   $0x8023ed
  801ba9:	e8 8e e5 ff ff       	call   80013c <_panic>
	
		sys_yield();
  801bae:	e8 4a f0 ff ff       	call   800bfd <sys_yield>
	}
  801bb3:	eb d0                	jmp    801b85 <ipc_send+0x1c>
