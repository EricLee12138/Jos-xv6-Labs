...
fsipc(unsigned type, void *dstva)
{
  ...
  80130f:	e8 2b 08 00 00       	call   801b3f <ipc_find_env>
  ...
  80132a:	e8 bc 07 00 00       	call   801aeb <ipc_send>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015e8:	e8 8b 05 00 00       	call   801b78 <pageref>
  8015ed:	89 c3                	mov    %eax,%ebx
  8015ef:	89 3c 24             	mov    %edi,(%esp)
  8015f2:	e8 81 05 00 00       	call   801b78 <pageref>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a89:	74 0e                	je     801a99 <ipc_recv+0x20>
        r = sys_ipc_recv(pg);
  801a8b:	83 ec 0c             	sub    $0xc,%esp
  801a8e:	50                   	push   %eax
  801a8f:	e8 74 f2 ff ff       	call   800d08 <sys_ipc_recv>
  801a94:	83 c4 10             	add    $0x10,%esp
  801a97:	eb 0d                	jmp    801aa6 <ipc_recv+0x2d>
	else
        r = sys_ipc_recv((void *)-1);
  801a99:	83 ec 0c             	sub    $0xc,%esp
  801a9c:	6a ff                	push   $0xffffffff
  801a9e:	e8 65 f2 ff ff       	call   800d08 <sys_ipc_recv>
  801aa3:	83 c4 10             	add    $0x10,%esp

	if (r < 0) {
  801aa6:	85 c0                	test   %eax,%eax
  801aa8:	79 16                	jns    801ac0 <ipc_recv+0x47>

		if (from_env_store != NULL)
  801aaa:	85 f6                	test   %esi,%esi
  801aac:	74 06                	je     801ab4 <ipc_recv+0x3b>
			*from_env_store = 0;
  801aae:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store != NULL)
  801ab4:	85 db                	test   %ebx,%ebx
  801ab6:	74 2c                	je     801ae4 <ipc_recv+0x6b>
			*perm_store = 0;
  801ab8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801abe:	eb 24                	jmp    801ae4 <ipc_recv+0x6b>
		return r;
  ...
  801ac2:	74 0a                	je     801ace <ipc_recv+0x55>
			*from_env_store = thisenv->env_ipc_from;
  801ac4:	a1 04 40 80 00       	mov    0x804004,%eax
  801ac9:	8b 40 74             	mov    0x74(%eax),%eax
  801acc:	89 06                	mov    %eax,(%esi)
		if (perm_store != NULL)
  801ace:	85 db                	test   %ebx,%ebx
  801ad0:	74 0a                	je     801adc <ipc_recv+0x63>
			*perm_store = thisenv->env_ipc_perm;
  801ad2:	a1 04 40 80 00       	mov    0x804004,%eax
  801ad7:	8b 40 78             	mov    0x78(%eax),%eax
  801ada:	89 03                	mov    %eax,(%ebx)
		return thisenv->env_ipc_value;
  801adc:	a1 04 40 80 00       	mov    0x804004,%eax
  801ae1:	8b 40 70             	mov    0x70(%eax),%eax
	}
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801afd:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;	
  801aff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ...
  801b0b:	56                   	push   %esi
  801b0c:	57                   	push   %edi
  801b0d:	e8 d3 f1 ff ff       	call   800ce5 <sys_ipc_try_send>
		if (r >= 0)
  801b12:	83 c4 10             	add    $0x10,%esp
  801b15:	85 c0                	test   %eax,%eax
  801b17:	79 1e                	jns    801b37 <ipc_send+0x4c>
			return;
		else if (r != -E_IPC_NOT_RECV)
  801b19:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801b1c:	74 12                	je     801b30 <ipc_send+0x45>
			panic("ipc_send error: %e", r);
  801b1e:	50                   	push   %eax
  801b1f:	68 dc 22 80 00       	push   $0x8022dc
  801b24:	6a 49                	push   $0x49
  801b26:	68 ef 22 80 00       	push   $0x8022ef
  801b2b:	e8 03 ff ff ff       	call   801a33 <_panic>
	
		sys_yield();
  801b30:	e8 04 f0 ff ff       	call   800b39 <sys_yield>
	}
  801b35:	eb d0                	jmp    801b07 <ipc_send+0x1c>
