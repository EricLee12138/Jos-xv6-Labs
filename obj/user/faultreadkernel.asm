	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 71 1e 80 00 	movsbl 0x801e71(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800383:	50                   	push   %eax
  800384:	68 89 1e 80 00       	push   $0x801e89
  800389:	53                   	push   %ebx
  80038a:	56                   	push   %esi
  ...
  8003c9:	b8 82 1e 80 00       	mov    $0x801e82,%eax
...
fsipc(unsigned type, void *dstva)
{
  ...
  8012ff:	e8 2b 08 00 00       	call   801b2f <ipc_find_env>
  ...
  80131a:	e8 bc 07 00 00       	call   801adb <ipc_send>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80145c:	68 54 22 80 00       	push   $0x802254
  ...
  801472:	68 3f 22 80 00       	push   $0x80223f
  801477:	6a 7d                	push   $0x7d
  801479:	68 54 22 80 00       	push   $0x802254
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80155c:	68 6b 22 80 00       	push   $0x80226b
  801561:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015d8:	e8 8b 05 00 00       	call   801b68 <pageref>
  8015dd:	89 c3                	mov    %eax,%ebx
  8015df:	89 3c 24             	mov    %edi,(%esp)
  8015e2:	e8 81 05 00 00       	call   801b68 <pageref>
  ...
  80160c:	50                   	push   %eax
  80160d:	56                   	push   %esi
  80160e:	68 72 22 80 00       	push   $0x802272
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018b0:	68 8a 22 80 00       	push   $0x80228a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a3f:	56                   	push   %esi
  801a40:	50                   	push   %eax
  801a41:	68 98 22 80 00       	push   $0x802298
  ...
  801a52:	e8 99 e6 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801a57:	c7 04 24 83 22 80 00 	movl   $0x802283,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a7e:	50                   	push   %eax
  801a7f:	e8 74 f2 ff ff       	call   800cf8 <sys_ipc_recv>
  ...
  801a8e:	e8 65 f2 ff ff       	call   800cf8 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801afb:	56                   	push   %esi
  801afc:	57                   	push   %edi
  801afd:	e8 d3 f1 ff ff       	call   800cd5 <sys_ipc_try_send>
		if (r >= 0)
  ...
  801b0e:	50                   	push   %eax
  801b0f:	68 bc 22 80 00       	push   $0x8022bc
  801b14:	6a 49                	push   $0x49
  801b16:	68 cf 22 80 00       	push   $0x8022cf
  801b1b:	e8 03 ff ff ff       	call   801a23 <_panic>
	
		sys_yield();
  801b20:	e8 04 f0 ff ff       	call   800b29 <sys_yield>
	}
