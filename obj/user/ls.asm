...
ls1(const char *prefix, bool isdir, off_t size, const char *name)
{
  ...
  80005f:	e8 ea 19 00 00       	call   801a4e <printf>
  ...
  80009d:	e8 ac 19 00 00       	call   801a4e <printf>
  ...
  8000b0:	e8 99 19 00 00       	call   801a4e <printf>
	if(flag['F'] && isdir)
  ...
  8000cf:	e8 7a 19 00 00       	call   801a4e <printf>
  8000d4:	83 c4 10             	add    $0x10,%esp
	printf("\n");
  8000d7:	83 ec 0c             	sub    $0xc,%esp
  8000da:	68 87 23 80 00       	push   $0x802387
  8000df:	e8 6a 19 00 00       	call   801a4e <printf>
}
...
lsdir(const char *path, const char *prefix)
{
  ...
  8000ff:	57                   	push   %edi
  800100:	e8 ab 17 00 00       	call   8018b0 <open>
...
usage(void)
{
  ...
  800225:	e8 24 18 00 00       	call   801a4e <printf>
	exit();
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80065a:	52                   	push   %edx
  80065b:	68 b5 27 80 00       	push   $0x8027b5
  800660:	53                   	push   %ebx
  800661:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800dad:	68 df 26 80 00       	push   $0x8026df
  800db2:	6a 23                	push   $0x23
  800db4:	68 fc 26 80 00       	push   $0x8026fc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800e70:	68 df 26 80 00       	push   $0x8026df
  800e75:	6a 23                	push   $0x23
  800e77:	68 fc 26 80 00       	push   $0x8026fc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800eb2:	68 df 26 80 00       	push   $0x8026df
  800eb7:	6a 23                	push   $0x23
  800eb9:	68 fc 26 80 00       	push   $0x8026fc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ef4:	68 df 26 80 00       	push   $0x8026df
  800ef9:	6a 23                	push   $0x23
  800efb:	68 fc 26 80 00       	push   $0x8026fc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800f36:	68 df 26 80 00       	push   $0x8026df
  800f3b:	6a 23                	push   $0x23
  800f3d:	68 fc 26 80 00       	push   $0x8026fc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f78:	68 df 26 80 00       	push   $0x8026df
  800f7d:	6a 23                	push   $0x23
  800f7f:	68 fc 26 80 00       	push   $0x8026fc
...
sys_ipc_recv(void *dstva)
{
  ...
  800fdc:	68 df 26 80 00       	push   $0x8026df
  800fe1:	6a 23                	push   $0x23
  800fe3:	68 fc 26 80 00       	push   $0x8026fc
...
argstart(int *argc, char **argv, struct Argstate *args)
{
  ...
  80100b:	ba 88 23 80 00       	mov    $0x802388,%edx
...
argnextvalue(struct Argstate *args)
{
  ...
  8010cc:	89 43 0c             	mov    %eax,0xc(%ebx)
		args->curarg = "";
  8010cf:	c7 43 08 88 23 80 00 	movl   $0x802388,0x8(%ebx)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80121e:	ba 8c 27 80 00       	mov    $0x80278c,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801249:	51                   	push   %ecx
  80124a:	50                   	push   %eax
  80124b:	68 0c 27 80 00       	push   $0x80270c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801473:	53                   	push   %ebx
  801474:	50                   	push   %eax
  801475:	68 50 27 80 00       	push   $0x802750
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801548:	53                   	push   %ebx
  801549:	50                   	push   %eax
  80154a:	68 6c 27 80 00       	push   $0x80276c
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8015fd:	53                   	push   %ebx
  8015fe:	50                   	push   %eax
  8015ff:	68 2c 27 80 00       	push   $0x80272c
...
stat(const char *path, struct Stat *stat)
{
  ...
  8016c8:	e8 e3 01 00 00       	call   8018b0 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  80170f:	e8 f5 08 00 00       	call   802009 <ipc_find_env>
  ...
  80172a:	e8 86 08 00 00       	call   801fb5 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  80172f:	83 c4 0c             	add    $0xc,%esp
  801732:	6a 00                	push   $0x0
  801734:	53                   	push   %ebx
  801735:	6a 00                	push   $0x0
  801737:	e8 07 08 00 00       	call   801f43 <ipc_recv>
}
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80185a:	78 4b                	js     8018a7 <devfile_read+0x79>
		return r;
	assert(r <= n);
  80185c:	39 c6                	cmp    %eax,%esi
  80185e:	73 16                	jae    801876 <devfile_read+0x48>
  801860:	68 9c 27 80 00       	push   $0x80279c
  801865:	68 a3 27 80 00       	push   $0x8027a3
  80186a:	6a 7c                	push   $0x7c
  80186c:	68 b8 27 80 00       	push   $0x8027b8
  801871:	e8 ae ea ff ff       	call   800324 <_panic>
	assert(r <= PGSIZE);
  801876:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80187b:	7e 16                	jle    801893 <devfile_read+0x65>
  80187d:	68 c3 27 80 00       	push   $0x8027c3
  801882:	68 a3 27 80 00       	push   $0x8027a3
  801887:	6a 7d                	push   $0x7d
  801889:	68 b8 27 80 00       	push   $0x8027b8
  80188e:	e8 91 ea ff ff       	call   800324 <_panic>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801893:	83 ec 04             	sub    $0x4,%esp
  801896:	50                   	push   %eax
  801897:	68 00 50 80 00       	push   $0x805000
  80189c:	ff 75 0c             	pushl  0xc(%ebp)
  80189f:	e8 ef f2 ff ff       	call   800b93 <memmove>
	return r;
...
open(const char *path, int mode)
{
  ...
  8018ba:	53                   	push   %ebx
  8018bb:	e8 08 f1 ff ff       	call   8009c8 <strlen>
  8018c0:	83 c4 10             	add    $0x10,%esp
  8018c3:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  8018c8:	7f 67                	jg     801931 <open+0x81>
		return -E_BAD_PATH;
  ...
  8018d0:	50                   	push   %eax
  8018d1:	e8 9a f8 ff ff       	call   801170 <fd_alloc>
  ...
  8018dd:	78 57                	js     801936 <open+0x86>
		return r;
  ...
  80192f:	eb 05                	jmp    801936 <open+0x86>
	...
	if (strlen(path) >= MAXPATHLEN)
		return -E_BAD_PATH;
  801931:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
		fd_close(fd, 0);
		return r;
	}
...
sync(void)
{
  ...
  801948:	b8 08 00 00 00       	mov    $0x8,%eax
  80194d:	e8 a6 fd ff ff       	call   8016f8 <fsipc>
}
  801952:	c9                   	leave  
  801953:	c3                   	ret    
...
{
	if (b->error > 0) {
  801954:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
  801958:	7e 37                	jle    801991 <writebuf+0x3d>
};
...
writebuf(struct printbuf *b)
{
  ...
  801963:	ff 70 04             	pushl  0x4(%eax)
  801966:	8d 40 10             	lea    0x10(%eax),%eax
  801969:	50                   	push   %eax
  80196a:	ff 33                	pushl  (%ebx)
  80196c:	e8 8e fb ff ff       	call   8014ff <write>
		if (result > 0)
  801971:	83 c4 10             	add    $0x10,%esp
  801974:	85 c0                	test   %eax,%eax
  801976:	7e 03                	jle    80197b <writebuf+0x27>
			b->result += result;
  801978:	01 43 08             	add    %eax,0x8(%ebx)
		if (result != b->idx) // error, or wrote less than supplied
  80197b:	3b 43 04             	cmp    0x4(%ebx),%eax
  80197e:	74 0d                	je     80198d <writebuf+0x39>
			b->error = (result < 0 ? result : 0);
  801980:	85 c0                	test   %eax,%eax
  801982:	ba 00 00 00 00       	mov    $0x0,%edx
  801987:	0f 4f c2             	cmovg  %edx,%eax
  80198a:	89 43 0c             	mov    %eax,0xc(%ebx)
	}
}
  80198d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801990:	c9                   	leave  
  801991:	f3 c3                	repz ret 
...
putch(int ch, void *thunk)
{
  ...
  80199a:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	b->buf[b->idx++] = ch;
  80199d:	8b 53 04             	mov    0x4(%ebx),%edx
  8019a0:	8d 42 01             	lea    0x1(%edx),%eax
  8019a3:	89 43 04             	mov    %eax,0x4(%ebx)
  8019a6:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8019a9:	88 4c 13 10          	mov    %cl,0x10(%ebx,%edx,1)
	if (b->idx == 256) {
  8019ad:	3d 00 01 00 00       	cmp    $0x100,%eax
  8019b2:	75 0e                	jne    8019c2 <putch+0x2f>
		writebuf(b);
  8019b4:	89 d8                	mov    %ebx,%eax
  8019b6:	e8 99 ff ff ff       	call   801954 <writebuf>
		b->idx = 0;
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  801a04:	50                   	push   %eax
  801a05:	68 93 19 80 00       	push   $0x801993
  801a0a:	e8 eb ea ff ff       	call   8004fa <vprintfmt>
	if (b.idx > 0)
  801a0f:	83 c4 10             	add    $0x10,%esp
  801a12:	83 bd ec fe ff ff 00 	cmpl   $0x0,-0x114(%ebp)
  801a19:	7e 0b                	jle    801a26 <vfprintf+0x5e>
		writebuf(&b);
  801a1b:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  801a21:	e8 2e ff ff ff       	call   801954 <writebuf>

	return (b.result ? b.result : b.error);
  801a26:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  801a2c:	85 c0                	test   %eax,%eax
  801a2e:	0f 44 85 f4 fe ff ff 	cmove  -0x10c(%ebp),%eax
}
  801a35:	c9                   	leave  
  801a36:	c3                   	ret    
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  801a47:	e8 7c ff ff ff       	call   8019c8 <vfprintf>
	va_end(ap);
...
printf(const char *fmt, ...)
{
  ...
  801a51:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  801a54:	8d 45 0c             	lea    0xc(%ebp),%eax
	cnt = vfprintf(1, fmt, ap);
  801a57:	50                   	push   %eax
  801a58:	ff 75 08             	pushl  0x8(%ebp)
  801a5b:	6a 01                	push   $0x1
  801a5d:	e8 66 ff ff ff       	call   8019c8 <vfprintf>
	va_end(ap);
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a72:	e8 e2 f6 ff ff       	call   801159 <fd2data>
  801a77:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801a79:	83 c4 08             	add    $0x8,%esp
  801a7c:	68 cf 27 80 00       	push   $0x8027cf
  801a81:	53                   	push   %ebx
  801a82:	e8 7a ef ff ff       	call   800a01 <strcpy>
...
devpipe_close(struct Fd *fd)
{
  ...
  801abf:	e8 c5 f3 ff ff       	call   800e89 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801ac4:	89 1c 24             	mov    %ebx,(%esp)
  801ac7:	e8 8d f6 ff ff       	call   801159 <fd2data>
  801acc:	83 c4 08             	add    $0x8,%esp
  801acf:	50                   	push   %eax
  801ad0:	6a 00                	push   $0x0
  801ad2:	e8 b2 f3 ff ff       	call   800e89 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801ae8:	89 d7                	mov    %edx,%edi
	...
	while (1) {
		n = thisenv->env_runs;
  801aea:	a1 20 44 80 00       	mov    0x804420,%eax
  801aef:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  801af2:	83 ec 0c             	sub    $0xc,%esp
  801af5:	ff 75 e0             	pushl  -0x20(%ebp)
  801af8:	e8 45 05 00 00       	call   802042 <pageref>
  801afd:	89 c3                	mov    %eax,%ebx
  801aff:	89 3c 24             	mov    %edi,(%esp)
  801b02:	e8 3b 05 00 00       	call   802042 <pageref>
  ...
  801b1b:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801b1e:	39 ce                	cmp    %ecx,%esi
  801b20:	74 1b                	je     801b3d <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  801b22:	39 c3                	cmp    %eax,%ebx
  801b24:	75 c4                	jne    801aea <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801b26:	8b 42 58             	mov    0x58(%edx),%eax
  801b29:	ff 75 e4             	pushl  -0x1c(%ebp)
  801b2c:	50                   	push   %eax
  801b2d:	56                   	push   %esi
  801b2e:	68 d6 27 80 00       	push   $0x8027d6
  801b33:	e8 c5 e8 ff ff       	call   8003fd <cprintf>
  801b38:	83 c4 10             	add    $0x10,%esp
  801b3b:	eb ad                	jmp    801aea <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801b54:	56                   	push   %esi
  801b55:	e8 ff f5 ff ff       	call   801159 <fd2data>
  ...
  801b64:	eb 4b                	jmp    801bb1 <devpipe_write+0x69>
  ...
  801b6a:	e8 6d ff ff ff       	call   801adc <_pipeisclosed>
  801b6f:	85 c0                	test   %eax,%eax
  801b71:	75 48                	jne    801bbb <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  801b73:	e8 6d f2 ff ff       	call   800de5 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  801b82:	73 e2                	jae    801b66 <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  801bb1:	3b 7d 10             	cmp    0x10(%ebp),%edi
  801bb4:	75 c2                	jne    801b78 <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  801bb9:	eb 05                	jmp    801bc0 <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801bd1:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801bd4:	57                   	push   %edi
  801bd5:	e8 7f f5 ff ff       	call   801159 <fd2data>
  ...
  801be4:	eb 3d                	jmp    801c23 <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  801be6:	85 db                	test   %ebx,%ebx
  801be8:	74 04                	je     801bee <devpipe_read+0x26>
				return i;
  801bea:	89 d8                	mov    %ebx,%eax
  801bec:	eb 44                	jmp    801c32 <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  801bee:	89 f2                	mov    %esi,%edx
  801bf0:	89 f8                	mov    %edi,%eax
  801bf2:	e8 e5 fe ff ff       	call   801adc <_pipeisclosed>
  801bf7:	85 c0                	test   %eax,%eax
  801bf9:	75 32                	jne    801c2d <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  801bfb:	e8 e5 f1 ff ff       	call   800de5 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  801c02:	3b 46 04             	cmp    0x4(%esi),%eax
  801c05:	74 df                	je     801be6 <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  801c07:	99                   	cltd   
  801c08:	c1 ea 1b             	shr    $0x1b,%edx
  801c0b:	01 d0                	add    %edx,%eax
  801c0d:	83 e0 1f             	and    $0x1f,%eax
  801c10:	29 d0                	sub    %edx,%eax
  801c12:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  801c17:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801c1a:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  801c1d:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  801c20:	83 c3 01             	add    $0x1,%ebx
  801c23:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  801c26:	75 d8                	jne    801c00 <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  801c2b:	eb 05                	jmp    801c32 <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
  ...
  801c32:	8d 65 f4             	lea    -0xc(%ebp),%esp
  801c35:	5b                   	pop    %ebx
  801c36:	5e                   	pop    %esi
  801c37:	5f                   	pop    %edi
  801c38:	5d                   	pop    %ebp
...
pipe(int pfd[2])
{
  ...
  801c45:	50                   	push   %eax
  801c46:	e8 25 f5 ff ff       	call   801170 <fd_alloc>
  801c4b:	83 c4 10             	add    $0x10,%esp
  801c4e:	89 c2                	mov    %eax,%edx
  801c50:	85 c0                	test   %eax,%eax
  801c52:	0f 88 2c 01 00 00    	js     801d84 <pipe+0x14a>
  ...
  801c71:	0f 88 0d 01 00 00    	js     801d84 <pipe+0x14a>
		goto err;
  ...
  801cb5:	e8 9f f4 ff ff       	call   801159 <fd2data>
  ...
  801d5a:	e8 2a f1 ff ff       	call   800e89 <sys_page_unmap>
  ...
  801d6a:	e8 1a f1 ff ff       	call   800e89 <sys_page_unmap>
  ...
  801d7a:	e8 0a f1 ff ff       	call   800e89 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801d9a:	e8 20 f4 ff ff       	call   8011bf <fd_lookup>
  801d9f:	83 c4 10             	add    $0x10,%esp
  801da2:	85 c0                	test   %eax,%eax
  801da4:	78 18                	js     801dbe <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801da6:	83 ec 0c             	sub    $0xc,%esp
  801da9:	ff 75 f4             	pushl  -0xc(%ebp)
  801dac:	e8 a8 f3 ff ff       	call   801159 <fd2data>
	return _pipeisclosed(fd, p);
  801db1:	89 c2                	mov    %eax,%edx
  801db3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801db6:	e8 21 fd ff ff       	call   801adc <_pipeisclosed>
  801dbb:	83 c4 10             	add    $0x10,%esp
}
  801dbe:	c9                   	leave  
  801dbf:	c3                   	ret    

00801dc0 <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801dd0:	68 ee 27 80 00       	push   $0x8027ee
  801dd5:	ff 75 0c             	pushl  0xc(%ebp)
  801dd8:	e8 24 ec ff ff       	call   800a01 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801df5:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801dfb:	eb 2d                	jmp    801e2a <devcons_write+0x46>
		m = n - tot;
  801dfd:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801e00:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  801e02:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  801e05:	ba 7f 00 00 00       	mov    $0x7f,%edx
  801e0a:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  ...
  801e14:	50                   	push   %eax
  801e15:	57                   	push   %edi
  801e16:	e8 78 ed ff ff       	call   800b93 <memmove>
		sys_cputs(buf, m);
  801e1b:	83 c4 08             	add    $0x8,%esp
  801e1e:	53                   	push   %ebx
  801e1f:	57                   	push   %edi
  801e20:	e8 23 ef ff ff       	call   800d48 <sys_cputs>
	int tot, m;
	char buf[128];
  ...
  801e2f:	72 cc                	jb     801dfd <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801e48:	74 2a                	je     801e74 <devcons_read+0x3b>
  801e4a:	eb 05                	jmp    801e51 <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801e4c:	e8 94 ef ff ff       	call   800de5 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801e51:	e8 10 ef ff ff       	call   800d66 <sys_cgetc>
  801e56:	85 c0                	test   %eax,%eax
  801e58:	74 f2                	je     801e4c <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  801e5a:	85 c0                	test   %eax,%eax
  801e5c:	78 16                	js     801e74 <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801e5e:	83 f8 04             	cmp    $0x4,%eax
  801e61:	74 0c                	je     801e6f <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  801e63:	8b 55 0c             	mov    0xc(%ebp),%edx
  801e66:	88 02                	mov    %al,(%edx)
	return 1;
  801e68:	b8 01 00 00 00       	mov    $0x1,%eax
  801e6d:	eb 05                	jmp    801e74 <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  801e7f:	88 45 f7             	mov    %al,-0x9(%ebp)
  ...
  801e87:	50                   	push   %eax
  801e88:	e8 bb ee ff ff       	call   800d48 <sys_cputs>
}
...
getchar(void)
{
  ...
  801ea0:	e8 80 f5 ff ff       	call   801425 <read>
	if (r < 0)
  801ea5:	83 c4 10             	add    $0x10,%esp
  801ea8:	85 c0                	test   %eax,%eax
  801eaa:	78 0f                	js     801ebb <getchar+0x29>
		return r;
	if (r < 1)
  801eac:	85 c0                	test   %eax,%eax
  801eae:	7e 06                	jle    801eb6 <getchar+0x24>
		return -E_EOF;
	return c;
  801eb0:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  801eb4:	eb 05                	jmp    801ebb <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  801eb6:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  801ebb:	c9                   	leave  
  801ebc:	c3                   	ret    
...
opencons(void)
{
  ...
  801ef2:	50                   	push   %eax
  801ef3:	e8 78 f2 ff ff       	call   801170 <fd_alloc>
...
opencons(void)
{
  ...
  801eff:	78 3e                	js     801f3f <opencons+0x56>
		return r;
  ...
  801f0e:	e8 f1 ee ff ff       	call   800e04 <sys_page_alloc>
  ...
  801f1a:	78 23                	js     801f3f <opencons+0x56>
		return r;
  ...
  801f34:	50                   	push   %eax
  801f35:	e8 0f f2 ff ff       	call   801149 <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f53:	74 0e                	je     801f63 <ipc_recv+0x20>
        r = sys_ipc_recv(pg);
  801f55:	83 ec 0c             	sub    $0xc,%esp
  801f58:	50                   	push   %eax
  801f59:	e8 56 f0 ff ff       	call   800fb4 <sys_ipc_recv>
  801f5e:	83 c4 10             	add    $0x10,%esp
  801f61:	eb 0d                	jmp    801f70 <ipc_recv+0x2d>
	else
        r = sys_ipc_recv((void *)-1);
  801f63:	83 ec 0c             	sub    $0xc,%esp
  801f66:	6a ff                	push   $0xffffffff
  801f68:	e8 47 f0 ff ff       	call   800fb4 <sys_ipc_recv>
  801f6d:	83 c4 10             	add    $0x10,%esp

	if (r < 0) {
  801f70:	85 c0                	test   %eax,%eax
  801f72:	79 16                	jns    801f8a <ipc_recv+0x47>

		if (from_env_store != NULL)
  801f74:	85 f6                	test   %esi,%esi
  801f76:	74 06                	je     801f7e <ipc_recv+0x3b>
			*from_env_store = 0;
  801f78:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store != NULL)
  801f7e:	85 db                	test   %ebx,%ebx
  801f80:	74 2c                	je     801fae <ipc_recv+0x6b>
			*perm_store = 0;
  801f82:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801f88:	eb 24                	jmp    801fae <ipc_recv+0x6b>
		return r;

	} else {

		if (from_env_store != NULL)
  801f8a:	85 f6                	test   %esi,%esi
  801f8c:	74 0a                	je     801f98 <ipc_recv+0x55>
			*from_env_store = thisenv->env_ipc_from;
  801f8e:	a1 20 44 80 00       	mov    0x804420,%eax
  801f93:	8b 40 74             	mov    0x74(%eax),%eax
  801f96:	89 06                	mov    %eax,(%esi)
		if (perm_store != NULL)
  801f98:	85 db                	test   %ebx,%ebx
  801f9a:	74 0a                	je     801fa6 <ipc_recv+0x63>
			*perm_store = thisenv->env_ipc_perm;
  801f9c:	a1 20 44 80 00       	mov    0x804420,%eax
  801fa1:	8b 40 78             	mov    0x78(%eax),%eax
  801fa4:	89 03                	mov    %eax,(%ebx)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801fbe:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  801fc7:	85 db                	test   %ebx,%ebx
		pg = (void *)-1;	
  801fc9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ...
  801fd5:	56                   	push   %esi
  801fd6:	57                   	push   %edi
  801fd7:	e8 b5 ef ff ff       	call   800f91 <sys_ipc_try_send>
		if (r >= 0)
  801fdc:	83 c4 10             	add    $0x10,%esp
  801fdf:	85 c0                	test   %eax,%eax
  801fe1:	79 1e                	jns    802001 <ipc_send+0x4c>
			return;
		else if (r != -E_IPC_NOT_RECV)
  801fe3:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801fe6:	74 12                	je     801ffa <ipc_send+0x45>
			panic("ipc_send error: %e", r);
  801fe8:	50                   	push   %eax
  801fe9:	68 fa 27 80 00       	push   $0x8027fa
  801fee:	6a 49                	push   $0x49
  801ff0:	68 0d 28 80 00       	push   $0x80280d
  801ff5:	e8 2a e3 ff ff       	call   800324 <_panic>
	
		sys_yield();
  801ffa:	e8 e6 ed ff ff       	call   800de5 <sys_yield>
	}
  801fff:	eb d0                	jmp    801fd1 <ipc_send+0x1c>
...
ipc_find_env(enum EnvType type)
{
  ...
  802014:	6b d0 7c             	imul   $0x7c,%eax,%edx
  802017:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  80201d:	8b 52 50             	mov    0x50(%edx),%edx
  802020:	39 ca                	cmp    %ecx,%edx
  802022:	75 0d                	jne    802031 <ipc_find_env+0x28>
			return envs[i].env_id;
  802024:	6b c0 7c             	imul   $0x7c,%eax,%eax
  802027:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80202c:	8b 40 48             	mov    0x48(%eax),%eax
  80202f:	eb 0f                	jmp    802040 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
	int i;
	for (i = 0; i < NENV; i++)
  802031:	83 c0 01             	add    $0x1,%eax
  802034:	3d 00 04 00 00       	cmp    $0x400,%eax
  802039:	75 d9                	jne    802014 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
